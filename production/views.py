...
host = 'http://ec2-18-220-133-108.us-east-2.compute.amazonaws.com'
            ...
            if incomplete:
                ...
                for i in petitionsValues:
                    ...
                    if counter!=5 and counter!=10  and i=="5":
                        ...
                        return render_to_response('userRatings/user/thankYou.html',{'msg': msg, 'iden': 0},context_instance=RequestContext(request), )
